...
<head>
  ...
  <style>
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    /* HERO */
    .hero {
      background: linear-gradient(135deg, var(--primary) 0%, #2a5298 60%, #1a6b5a 100%);
      min-height: 82vh;
      display: flex;
      align-items: center;
      position: relative;
    ...
    .public-footer strong { color: rgba(200,216,240,0.9); }
...
<footer class="public-footer">
  ...
  Encadré par <strong>Dr. LAACHEMI</strong>
</footer>
